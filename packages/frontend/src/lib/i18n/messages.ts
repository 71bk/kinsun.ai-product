...
const zhHant = {
  ...
  'serviceRecord.boundary': '僅記錄本次人工服務內容。提交紀錄不代表完成派案，也不會成為已覆核照護事件。',
...
const en: Record<MessageKey, string> = {
  ...
  'serviceRecord.boundary': 'Record human-delivered services for this visit only. Submitting a record does not complete the assignment or create a verified care event.',
