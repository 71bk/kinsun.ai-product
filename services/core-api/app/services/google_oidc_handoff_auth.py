"""Authentication for the private BFF-to-Core Google handoff boundary."""
...
class GoogleOidcHandoffAuthenticator:
    """Verify one dedicated bearer secret without reusing user credentials."""
    ...
    def __init__(self, secret: str) -> None:
        if (
            ...
            raise ValueError("Google OIDC handoff secret must contain at least 32 bytes")
        self._secret = secret
