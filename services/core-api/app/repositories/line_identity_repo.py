...
class LineIdentityRepository:
    """Store keyed external identities without ever persisting raw LINE IDs."""
    ...
    async def claim_webhook_event(
        ...
        *,
        ...
        # Never acknowledge an attempt that may still commit successfully,
        # including the final allowed attempt. Its concurrent redelivery must
        # keep LINE retrying until it becomes COMPLETED, FAILED, or stale.
