"""add LINE account linking aggregates

Revision ID: a7c4e2d19f60
Revises: c1a9e7f24b63
Create Date: 2026-08-02 01:00:00+00:00
"""
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        *_timestamps(),
        ...
        sa.UniqueConstraint(
            "nonce_digest",
            name="uq_line_link_challenge_nonce_digest",
        ),
        schema="eldercare_ai",
    )
    op.create_index(
