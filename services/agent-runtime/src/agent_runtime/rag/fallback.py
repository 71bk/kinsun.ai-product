...
from agent_runtime.rag.models import RetrievalResponseV1, RetrievalResponseV2
...
def no_data_response_v2(request_id: str, *, insufficient: bool = False) -> RetrievalResponseV2:
    message = INSUFFICIENT_DATA_MESSAGE if insufficient else NO_DATA_MESSAGE
...
def failed_response_v2(request_id: str) -> RetrievalResponseV2:
    return RetrievalResponseV2(
        schema_version="2.0.0",
        request_id=request_id,
        status="FAILED",
