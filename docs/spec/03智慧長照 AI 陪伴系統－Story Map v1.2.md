...
| Demo Gate 1<br>跨 Wave 薄切片 | [US-A06] 分層同意與資料用途控制 | [US-A01] 低操作負擔的語音入口<br>[US-A02] 國語與臺語語音辨識<br>[US-A03] 符合語言偏好的語音回覆<br>[US-A05] 對話失敗的安全降級 | [US-A04] 情境感知對話 | [US-B01] 自動擷取結構化生活與社交事件<br>[US-D01] 產生候選記憶 | [US-B03] 照護者修正與覆核<br>[US-D02] 確認後才保存 | [US-B04] 事件時間軸<br>[US-D03] 記憶檢索與個人化回應 | [US-B02] 每日 AI 摘要<br>[US-C01] 專業照護者概覽與派案入口（薄版本）<br>[US-C02] 長者詳情頁 |  |  |  |
| Wave 1<br>核心記憶 | [US-A06] 分層同意與資料用途控制 | [US-A01] 低操作負擔的語音入口<br>[US-A02] 國語與臺語語音辨識<br>[US-A03] 符合語言偏好的語音回覆<br>[US-A05] 對話失敗的安全降級 | [US-A04] 情境感知對話 | [US-B01] 自動擷取結構化生活與社交事件<br>[US-D01] 產生候選記憶 | [US-D02] 確認後才保存<br>[US-D04] 更正、停用與刪除記憶 | [US-D03] 記憶檢索與個人化回應 |  |  |  |  |
...
| US-D01 | EPIC D｜確認式 AI 長期記憶 | 長者 | 擷取生活事件 | 產生候選記憶 | 身為長者，我希望 AI 能記得我的偏好與生活習慣，但不要將每句話都永久保存。 | MUST SHIP | Wave 1 | 核心 A/B｜情境記憶＋生活資料 | 是 | 僅針對穩定偏好、重要關係與固定作息產生候選記憶。 | 一般閒聊、一次性事件、敏感健康推測及陪伴需求推估，不得直接轉為長期記憶。 | US-B01；TE-J03 | 先做最薄可演示版本，再依原 Wave 擴充完整驗收 |
| US-D02 | EPIC D｜確認式 AI 長期記憶 | 長者 | 確認與管理記憶 | 確認後才保存 | 身為長者，我希望 AI 在記錄重要事項前先詢問我的意見。 | MUST SHIP | Wave 1 | 核心 A/B｜情境記憶＋生活資料 | 是 | 系統須以簡短問題詢問使用者是否同意保存。 | 若長者拒絕，系統不得將該內容寫入長期記憶。 | US-D01；US-A06 | 先做最薄可演示版本，再依原 Wave 擴充完整驗收 |
| US-D03 | EPIC D｜確認式 AI 長期記憶 | 長者 | 再次引用與生活回顧 | 記憶檢索與個人化回應 | 身為長者，我希望 AI 在適當時機引用已確認記憶，避免重複詢問已知資訊。 | MUST SHIP | Wave 1 | 核心 A/B｜情境記憶＋生活資料 | 是 | 僅檢索與當前對話相關的少量已確認記憶。 | 引用內容必須嚴格屬於同一位長者，嚴禁跨使用者資料洩漏。 | US-D02；TE-GR01 | 先做最薄可演示版本，再依原 Wave 擴充完整驗收 |
| US-D04 | EPIC D｜確認式 AI 長期記憶 | 長者／授權照護者 | 確認與管理記憶 | 更正、停用與刪除記憶 | 身為長者或授權照護者，我希望能夠更正或刪除錯誤的記憶內容。 | MUST SHIP | Wave 1 | 核心 A/B｜情境記憶＋生活資料 | 否 | 後台系統須提供檢視、更正、停用及刪除記憶的操作介面。 | 已刪除或停用的記憶不得再次被檢索或於對話中使用。 | US-D02；TE-GR03 | 依 Wave 交付 |
...
| 8 | 長者 | 確認是否保存重要記憶 | 以短句詢問；接受、拒絕或稍後處理 | US-D02 | Companion／Memory | confirmation_status | 拒絕時不建立正式記憶 | 辨識不清時不寫入 |  |
