...
`v005/pytest-rag-ingestion.xml`, `v005/pytest-execution-receipt.json`, and
`v005/test-evidence.json` are the active evidence sources for the formal
...
`v001/` through `v004/` remain immutable historical evidence. The v003 files
...
as a failed audit attempt and is not active evidence.
