"""Build owner acceptance v004 and immutable runtime policy v002."""
...
def main() -> int:
    try:
        build_owner_assessment_response_acceptance(REPOSITORY_ROOT)
        summary = build_source_family_runtime_policy_v2(REPOSITORY_ROOT)
