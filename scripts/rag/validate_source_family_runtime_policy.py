"""Validate the immutable staging runtime projection for source-family policy v002."""
...
from rag_ingestion.source_family_runtime_policy import (  # noqa: E402
...
def main() -> int:
    try:
        summary = validate_source_family_runtime_policy(REPOSITORY_ROOT)
